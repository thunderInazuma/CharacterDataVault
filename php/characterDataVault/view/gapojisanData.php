...
<!-- 				</ul></li> -->
	...
	<div id="contentsArea">
		...
		<datalist id='skillDataList'>
			...
			<option value='必殺技'></option>
			<option value='武装'></option>
			<option value='溜め'></option>
			<option value='鉄壁'></option>
			<option value='呪詛'></option>
			<option value='拳で語る'></option>
			<option value='崩し'></option>
			<option value='痕跡'></option>
			<option value='かばう'></option>
			<option value='食餌'></option>
			<option value='離すかよ'></option>
			<option value='復讐鬼'></option>
			<option value='※洗練：'></option>
			<option value='※調査：'></option>
			<option value='※防御：'></option>
			<option value='※攻撃：'></option>
			<option value='誓い'></option>
			<option value='ドジっこ'></option>
			<option value='裏の顔：'></option>
			<option value='離れ業：攻撃/対抗'></option>
			<option value='聞き耳'></option>
			<option value='緊急回避'></option>
			<option value='※パージ'></option>
			<option value='※火炎放射'></option>
			<option value='※マルチタスク'></option>
			<option value='※封印術'></option>
			<option value='※禁呪'></option>
			<option value='※奥義'></option>
			<option value='※天才'></option>
			<option value='伝家の宝刀'></option>
			<option value='コンプレックス'></option>
			<option value='殺戮（脅威スキル）'></option>
			<option value='※デュアルアタック（脅威スキル）'></option>
			<option value='狂気（脅威スキル）'></option>
			<option value='群体（脅威スキル）'></option>
			<option value='ディザスター（脅威スキル）'></option>
			<option value='縁：（脅威スキル）'></option>
			<option value='クリーチャー（脅威スキル）'></option>
			<option value='誘惑（脅威スキル）'></option>
			<option value='※悪臭（脅威スキル）'></option>
			<option value='※対策：（脅威スキル）'></option>
			<option value='※連続行動（脅威スキル）'></option>
			<option value='※秘密（脅威スキル）'></option>
			<option value='※悪意（脅威スキル）'></option>
			<option value='※お巡りさん（脅威スキル）'></option>
			<option value='※強襲（脅威スキル）'></option>
		</datalist>
